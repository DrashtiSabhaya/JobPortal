<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CompanyMaster.master" CodeFile="CompanyShortlisted.aspx.cs" Inherits="CompanyShortlisted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="search-jobs">
        <div class="container">
            <div class="heading">
                <h1><span>Shortlisted</span> Employees</h1>
            </div>
                                        ...
                                        <ItemTemplate>
                                            <table class="job-post-main row">
                                                ...
                                                <tr class="job-single-sec">
                                                    ...
                                                    <td>
                                                        <p><i class="fa fa-eye"></i><a href="#">View full Job Description</a></p>
                                                    </td>
