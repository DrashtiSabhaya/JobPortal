<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CompanyMaster.master" CodeFile="CompanyJobSeeker.aspx.cs" Inherits="CompanyJobSeeker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="search-jobs">
        <div class="container">
            <div class="heading">
                <h1><span>Job</span> Candiadtes</h1>
            </div>
